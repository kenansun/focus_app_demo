         ...
         <div className="relative z-20 w-full max-w-[360px] mx-4 animate-in slide-in-from-bottom-10 fade-in duration-500">
            ...
            <div className="flex flex-col bg-background-light dark:bg-surface-dark rounded-2xl shadow-2xl overflow-hidden ring-1 ring-white/10">
               ...
               <div className="px-6 py-2">
                  <div className="flex flex-col sm:flex-row gap-4 p-5 bg-primary/10 border border-primary/30 rounded-xl relative overflow-hidden">
                     ...
                     <div className="flex flex-1 flex-col gap-1 items-center sm:items-start text-center sm:text-left relative z-10">
                        ...
                        <p className="text-slate-900 dark:text-white text-3xl font-bold leading-none tracking-tight">45 <span className="text-base font-medium opacity-60">min</span></p>
                     </div>
                     ...
                     <div className="flex flex-1 flex-col gap-1 items-center sm:items-start text-center sm:text-left relative z-10">
                        ...
                        <p className="text-primary text-3xl font-bold leading-none tracking-tight">+7 <span className="text-base font-medium opacity-60 text-slate-900 dark:text-white">min</span></p>
                     </div>
                  </div>
               </div>
               ...
               <div className="px-6 pb-8 pt-6">
                  ...
                  <button className="mt-4 w-full text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 text-sm font-medium transition-colors">View detailed stats</button>
               </div>
            </div>
         </div>
      </div>
    ...
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white h-full w-full flex flex-col items-center px-6 pt-12 pb-4">
       ...
       <div className="w-full max-w-[480px] bg-white dark:bg-surface-dark rounded-xl p-6 shadow-sm border border-slate-100 dark:border-slate-800 mb-8">
          <div className="flex justify-between items-start mb-4">
             <div>
                <p className="text-slate-500 text-sm font-medium uppercase tracking-wider">Time Focus</p>
                <div className="flex items-baseline gap-2 mt-1">
                   <span className="text-3xl font-bold">12 min</span>
                   <span className="text-slate-500 text-sm font-medium">/ 25 min</span>
                </div>
             </div>
       ...
       <div className="flex w-full max-w-[480px] flex-col gap-3 mt-auto">
          <button onClick={() => navigate('/focus')} className="w-full h-14 rounded-xl bg-primary hover:bg-blue-600 text-white font-bold text-base shadow-lg shadow-blue-500/20">Try Again</button>
